# Script Name : Run-SqlScripts.ps1
...
function Run-SqlScripts {
<#
.Synopsis
   Runs multipale sql scripts on a given SQL server and sends a mail with the response
.EXAMPLE
   Run-SqlScripts -SqlFolder 'D:\temp\SQLScripts' -Mail 'Rotems@cio.gov.il' -DataSource '192.168.178.25' -Database 'Orchestrator_DB'
.INPUTS
...
#>
    ...
    Begin {
        ...
        $PSDefaultParameterValues = @{
            ...
            'Send-MailMessage:cc'         = 'sefi@cio.gov.il';
    ...
    Process {
        ...
        Foreach ($File in $SqlFiles){
            ...
            Send-MailMessage -Body $Body -Subject $MailSubject -Encoding utf8 -BodyAsHtml -cc 'akavia@cio.gov.il'
...
$SqlFolder = 'E:\Temp\Rotems\VersionScripts\Testing'
Run-SqlScripts -SqlFolder $SqlFolder -Mail 'rotems@cio.gov.il' 

# $SqlFolder = 'E:\Temp\RotemTestSQL'
# $Email = 'akavia@cio.gov.il'
