...
param ($ConfigSet = 'Production', $Email = 'Automation@cio.gov.il', [Array]$Sources = ('D:\www\'))
# Global Variables:
...
$Config1 = @{DB = '192.168.156.125';SOA = '192.168.178.226'; URL = 'https://rishuybniya.moin.gov.il'}
$Config2 = @{DB = '192.168.178.112';SOA = '192.168.156.81'; URL = 'https://f6.rishuybniya.moin.gov.il'}
